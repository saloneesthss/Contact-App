...
public class HomePage extends AppCompatActivity implements ContactAdapter.OnContactClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fabAdd).setOnClickListener(v -> {
            startActivity(new Intent(HomePage.this, AddEditContactActivity.class));
        });
    }
    ...
    public void onContactClick(Contact contact) {
        Intent intent = new Intent(HomePage.this, ContactDetailActivity.class);
    ...
    public void onEditClick(Contact contact) {
        Intent intent = new Intent(HomePage.this, AddEditContactActivity.class);
        intent.putExtra("contact_id", contact.getId());
        startActivity(intent);
    }
